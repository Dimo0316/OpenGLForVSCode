...
int main(int argc, char *argv[])
{
    ...
    float fov = 30.0f; //视锥体角度
    glm::vec3 view_translate = glm::vec3(0.0f, 0.0f, -3.0f);
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::SliderFloat("view x", &view_translate.x, -10.0, 10.0);
        ImGui::SliderFloat("view y", &view_translate.y, -10.0, 10.0);
        ImGui::SliderFloat("view z", &view_translate.z, -10.0, 10.0);
